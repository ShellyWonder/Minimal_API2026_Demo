namespace MinimalAPI2026Demo.Endpoints.Artifacts
{
    ...
    {
        //Note: This is a static class that contains extension methods for mapping artifact endpoints in a minimal API application.
        //It defines public and private endpoint groups, each with its own set of routes for handling artifact-related operations.
        //Per application SRS, delete functionality is not implemented because artifact are transferred/warehoused, not deleted. 
